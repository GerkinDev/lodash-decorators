...
exports.bindAll = exports.BindAll = void 0;
    ...
    while (proto && proto !== Object.prototype) {
        for (var _i = 0, _a = Object.getOwnPropertyNames(proto); _i < _a.length; _i++) {
            ...
            if (descriptor && include && key !== 'constructor') {
                ...
                if ((0, isFunction_1.default)(proto[key]) && boundKeys.indexOf(key) === -1) {
                    Object.defineProperty(targetProto, key, (0, bind_1.Bind)(proto, key, descriptor));
                    boundKeys.push(key);
                }
            }
        }
