...
exports.wrapConstructor = void 0;
...
function wrapConstructor(Ctor, wrapper) {
    function ConstructorWrapper() {
        ...
        return wrapper.call.apply(wrapper, (0, tslib_1.__spreadArray)([this, Ctor], args, false));
    }
    ...
    return (0, assignAll_1.assignAll)(ConstructorWrapper, Ctor, PROPERTY_EXCLUDES);
}
