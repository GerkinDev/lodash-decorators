...
var WrapApplicator = /** @class */ (function (_super) {
    ...
    WrapApplicator.prototype.apply = function (_a) {
        ...
        return function () {
            ...
            return execute((0, utils_1.resolveFunction)(args[0], this, target), value).apply(this, invokeArgs);
        };
    };
