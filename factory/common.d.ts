...
export declare type ApplicatorToken = new () => Applicator;
...
export declare type BiTypedMethodDecoratorN = ((...args: any[]) => TypedPropertyDescriptor<(...newArgs: any[]) => void>) & LodashMethodDecorator;
...
export declare type BiTypedDecoratorN = ((...args: any[]) => LodashDecorator & TypedPropertyDescriptor<any>) & LodashDecorator;
